...
/**
 * Die View ist das V aus MVC. Dabei geht es um alles, was dem Client (Browser)
 ...
 *        sollte der Ganze HTML Code sein, welcher bei allen Seiten gleich ist
 *        und vor den Inhalt kommt. Dadurch entstehen keine Redundanzen.
 *   2. Die Datei, welche so heisst wie im Konstruktor übergeben wird gerendert.
 *        Darin sollte der Ganze HTML Code sein, welcher speziell für diese
 *        Seite gedacht ist.
...
class View
{
    ...
    public function display()
    {
        ...
        //Wenn der User eingeloggt ist, wird ihm der 'private' Header angezeigt, sonst der öffentliche.
        if(UserController::IsUserLoggedIn()) {
            require './../view/header-private.php';
        }
        else {
            require './../view/header-public.php';
        }
